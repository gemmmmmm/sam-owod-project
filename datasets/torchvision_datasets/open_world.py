...
class OWDetection(VisionDataset):
    ...
    def __init__(self, args, root, years='2012', image_sets='train', transform=None, target_transform=None,
                 transforms=None, no_cats=False, filter_pct=-1, sam_integration=None):
        ...
        self.args = args
        self.sam_integration = sam_integration
